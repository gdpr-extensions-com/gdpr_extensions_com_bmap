...
{
    /**
     * @var \GdprExtensionsCom\GdprExtensionsComBmap\Domain\Model\GdprManager|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \GdprExtensionsCom\GdprExtensionsComBmap\Domain\Model\GdprManager::class,
            ['dummy']
        );
    }
